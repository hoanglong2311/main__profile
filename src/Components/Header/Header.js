...
function Header() {
    ...
    return <>
        <header className={styles.header}>
            {IsNotMobile() && <a href="#home" className={styles.title}>
                <h1 className={styles}>
                    Nguyen Hai
                </h1>
            </a>}
            <div className={styles.changeTheme}>
                ...
                <ul className={styles.list} ref={listRef}>
                    <li onClick={vidContext.handleVideo} className={styles.item}>
                        <img src="img/bg-1.jpg" className={styles.video__item} data-vid="video1"></img>
                    </li>
                    <li onClick={vidContext.handleVideo} className={styles.item}>
                        <img src="img/bg-2.jpg" className={styles.video__item} data-vid="video2"></img>
                    </li>
                </ul>
            </div>
        </header>
